...
#include <stddef.h>
#include "person_msgs/srv/query__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers person_msgs__srv__query__rosidl_typesupport_introspection_c__Query_service_members = {
  "person_msgs__srv",  // service namespace
  "Query",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // person_msgs__srv__query__rosidl_typesupport_introspection_c__Query_Request_message_type_support_handle,
  NULL  // response message
  // person_msgs__srv__query__rosidl_typesupport_introspection_c__Query_Response_message_type_support_handle
};

static rosidl_service_type_support_t person_msgs__srv__query__rosidl_typesupport_introspection_c__Query_service_type_support_handle = {
  0,
  &person_msgs__srv__query__rosidl_typesupport_introspection_c__Query_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, person_msgs, srv, Query)() {
  if (!person_msgs__srv__query__rosidl_typesupport_introspection_c__Query_service_type_support_handle.typesupport_identifier) {
    person_msgs__srv__query__rosidl_typesupport_introspection_c__Query_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)person_msgs__srv__query__rosidl_typesupport_introspection_c__Query_service_type_support_handle.data;
  ...
  return &person_msgs__srv__query__rosidl_typesupport_introspection_c__Query_service_type_support_handle;
}
