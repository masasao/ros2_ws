...
#ifndef PERSON_MSGS__MSG__PERSON__STRUCT_HPP_
#define PERSON_MSGS__MSG__PERSON__STRUCT_HPP_
...
struct Person_
{
  ...
  explicit Person_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit Person_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : name(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PERSON_MSGS__MSG__PERSON__STRUCT_HPP_
